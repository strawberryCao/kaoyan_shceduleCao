/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 87c844b8ecd7279ffba62adf241b0a26)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_USERNAME">> {}
}
