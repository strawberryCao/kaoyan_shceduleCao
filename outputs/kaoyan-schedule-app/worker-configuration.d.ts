/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6e410352b87c26bc51f696437ad2c48c)
...
interface __BaseEnv_Env {
	...
	GITHUB_OWNER: "strawberryCao";
	GITHUB_REPO: "Caobijidata";
	GITHUB_BRANCH: "main";
	CAPTURE_WORKFLOW: Workflow<Parameters<import("./cloudflare/index").CaptureWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_USERNAME" | "PUBLIC_READ_ENABLED" | "GITHUB_OWNER" | "GITHUB_REPO" | "GITHUB_BRANCH">> {}
}
