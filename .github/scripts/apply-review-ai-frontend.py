...
# AI config task and background status UI.
...
# Direct edit/delete/re-analyse controls in Learning Center.
...
print('Applied front-end review status and editable wrong-reason controls.')
